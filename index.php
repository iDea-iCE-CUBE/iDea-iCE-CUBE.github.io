...
<body>
<header>
    <a href="./index.html"><img id="logo" src="img/iceLogo.jpg" alt="ice logo"/></a>
    <nav>
...
<div id="centerBox">
    <div id="load0" class="card" style="display:none">
        <div id="load0text">
            <h1>关于丨info</h1>
            <p>
                <strong class="minScreen">检测到您是移动端设备，已自动设定宽高样式!</strong><br class="minScreen"/><br class="minScreen"/>
    ...
    <div id="load1">
        ...
        <div id="smallSecBox">
            ...
            <a href="official/register.html">
                <div class="smallSec button" id="smallSec3" style=";margin-top:20px;background-image: url('img/i4.png');"></div>
            </a>
