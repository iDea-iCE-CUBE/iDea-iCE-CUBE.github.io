...
window.onload=function(){
    ...
    //黑暗模式检测（切换）
    if(DLModeValue == "dark"){
    $("body").css({"background-color": "#2C2F3C","color": "white","background-image":"url(picture/homePicDark.png)"});
...
function openMenu(){
    ...
    $("#developerOptions").animate({"right":"5%"},300);
    flag = 1;
    }else{
    $("#occlusionLayer").fadeOut("50");
    $("#developerOptions").animate({"right":"-80%"},300,"swing");
    flag = 2;
}}
function deBug(){
...
if(text[0] == "dark"){
    //深色模式开启
    $("body").css({"background-color": "#2C2F3C","color": "white","background-image":"url(./picture/homePicDark.png)"});
    $(".darkLightInput").animate({ "background-color": "#262631" ,"border-bottom-color": "white","color": "white"}, 1000);
    ...
    //浅色模式开始
    $("body").css({"background-color": "#F5F5F4","color": "black","background-image":"url(picture/homePic.png)"});
    $(".darkLightInput").animate({ "background-color": "white" ,"border-bottom-color": "black","color": "black"}, 1000);
    $(".darkLightTop").animate({ "background-co    lor": "white" }, 1000);
